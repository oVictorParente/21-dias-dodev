...
postData('https://apigenerator.dronahq.com/api/FNGeMulr/Carros', novoCarro1)
.then((data) => {
    console.log(data);
});
...
//}
//
//deleteData('https://apigenerator.dronahq.com/api/N6noIZL5/Carros/2')
//.then((data) => {
//    console.log(data);  
//
//});
//
//
//const updateCar = {Valor: 200000, Quilometragem: 20000}
//
...
//}
//
//updateData('https://apigenerator.dronahq.com/api/FNGeMulr/Carros', 2, updateCar)
//.then((data) => {
//    console.log(data);  
//
//});